...
See `nextjs-boilerplate/hearty-bridge/AGENTS.md` for full app-specific instructions.
...
See `nextjs-boilerplate/hearty-bridge/AGENTS.md` → **WSL Environment** section for full details.
